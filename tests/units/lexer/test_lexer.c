...
static struct token_list_params token_list_params[] = {
    ...
    { .name_test = "pipe_two_simple_commands",
      ...
      .result = { { WORD, "echo" },
                  ...
                  { END_OF_FILE, "" } },
      .policy = DISABLE_KEYWORDS },
    { .name_test = "while_do_done",
      .input = "while true; do echo INFINIIII; done",
      .result = { { WHILE, "" },
                  { WORD, "true" },
                  { SEMICOLON, "" },
                  { DO, "" },
                  ...
                  { END_OF_FILE, "" } },
      .policy = ENABLE_KEYWORDS },
    { .name_test = "until_do_done",
      .input = "until true; do echo INFINIIII; done",
      .result = { { UNTIL, "" },
                  { WORD, "true" },
                  { SEMICOLON, "" },
                  { DO, "" },
                  ...
                  { END_OF_FILE, "" } },
      .policy = ENABLE_KEYWORDS },
    { .name_test = "for_do_done",
      .input = "for i do echo 42sh; done",
      .result = { { FOR, "" },
                  { WORD, "i" },
                  { DO, "" },
                  { WORD, "echo" },
                  ...
                  { END_OF_FILE, "" } },
      .policy = ENABLE_KEYWORDS },
    { .name_test = "for_in_do_done",
      .input = "for i; in 1 2 3 do echo 42sh; done",
      .result = { { FOR, "" },
                  { WORD, "i" },
                  { SEMICOLON, "" },
                  { IN, "" },
                  ...
                  { END_OF_FILE, "" } },
      .policy = ENABLE_KEYWORDS },
    { .name_test = "pipe_double_pipe_ampersand_double_ampersand",
      .input = "| || & &&",
      .result = { { PIPE, "" },
                  { DOUBLE_PIPE, "" },
                  { AMPERSAND, "" },
...
static struct token_consistency_params token_consistency_params[] = {
    ...
    { .name_test = "consistency_pipe",
      ...
      .enable = { PIPE, "" },
      .disable = { PIPE, "" } },
    { .name_test = "consistency_do",
      .input = "do",
      .enable = { DO, "" },
      .disable = { WORD, "do" } },
    { .name_test = "consistency_done",
      .input = "done",
      .enable = { DONE, "" },
      .disable = { WORD, "done" } },
    { .name_test = "consistency_while",
      .input = "while",
      .enable = { WHILE, "" },
      .disable = { WORD, "while" } },
    { .name_test = "consistency_until",
      .input = "until",
      .enable = { UNTIL, "" },
      .disable = { WORD, "until" } },
    { .name_test = "consistency_double_pipe",
      .input = "||",
      .enable = { DOUBLE_PIPE, "" },
      .disable = { DOUBLE_PIPE, "" } },
    { .name_test = "consistency_ampersand",
      .input = "&",
      .enable = { AMPERSAND, "" },
      .disable = { AMPERSAND, "" } },
    { .name_test = "consistency_double_ampersand",
      .input = "&&",
      .enable = { DOUBLE_AMPERSAND, "" },
      .disable = { DOUBLE_AMPERSAND, "" } },
    { .name_test = "consistency_for",
      .input = "for",
      .enable = { FOR, "" },
      .disable = { WORD, "for" } },
